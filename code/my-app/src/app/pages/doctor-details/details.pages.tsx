...
export default function DoctorDetailPage() {
  ...
  return (
    <>
      ...
      <main className="bg-gray-50 min-h-screen justify-center items-center flex gap-12 py-8">
        <section>
          <div className="bg-gray-100 border border-gray-300 shadow-xl rounded-2xl p-20 max-w-md w-full text-center">
            <img
              ...
              className="w-46 h-46 mx-auto rounded-xl border-4  shadow-md object-cover"
            />
            <h1 className="mt-4 text-2xl font-bold text-gray-900 ">
              {doctor.first_name}
            </h1>
            <div className="display flex-col">
              <p className="display flex-row font-medium">
